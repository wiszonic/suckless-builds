...
/* bar */
static const unsigned int heightpx  = 5;        /* bar height */
...
static const char *monocles[] = { "M" };						/* keep label */
//static const char *monocles[] = { "1", "2", "3", "4", "5", "6", "7", "8", "9" };	/* start counting */
...
static const char *incvolcmd[] = { "wpctl", "set-volume", "@DEFAULT_AUDIO_SINK@", "2%+", NULL };
static const char *decvolcmd[] = { "wpctl", "set-volume", "@DEFAULT_AUDIO_SINK@", "2%-", NULL };
static const char *mutvolcmd[] = { "wpctl", "set-mute", "@DEFAULT_AUDIO_SINK@", "toggle", NULL };

static const char *incmiccmd[] = { "wpctl", "set-volume", "@DEFAULT_AUDIO_SOURCE@", "2%+", NULL };
static const char *decmiccmd[] = { "wpctl", "set-volume", "@DEFAULT_AUDIO_SOURCE@", "2%-", NULL };
